...
import PostPuma.auth.Authentication;
import PostPuma.auth.HttpBasicAuth;
import PostPuma.auth.HttpBearerAuth;
import PostPuma.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://app.postpuma.com/app/5afgg2-1egj4n-7612ng-g313ie";
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        put("host", new ServerVariable(
          "The full PostPuma API path with workspace UUID",
          "https://app.postpuma.com/app/5afgg2-1egj4n-7612ng-g313ie",
          new HashSet<String>(
          )
        ));
      }}
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://app.postpuma.com/app/5afgg2-1egj4n-7612ng-g313ie
     ...
     * @return a {@link PostPuma.ApiClient} object
     */
    ...
    */
     ...
     * @throws PostPuma.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws PostPuma.ApiException If fail to serialize the given object
     */
     ...
     * @throws PostPuma.ApiException If fail to read file content from response and write to disk
     ...
     * @throws PostPuma.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws PostPuma.ApiException If the response has an unsuccessful status code or
     ...
     * @throws PostPuma.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws PostPuma.ApiException If fails to update the parameters
     */
     ...
     * @throws PostPuma.ApiException If fail to serialize the request body object into a string
     */
