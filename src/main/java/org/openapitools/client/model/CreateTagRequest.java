...
public class CreateTagRequest {
  ...
  public CreateTagRequest hexColor(String hexColor) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createTagRequest.name) &&
        Objects.equals(this.hexColor, createTagRequest.hexColor);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("hex_color");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("hex_color").isJsonPrimitive()) {
